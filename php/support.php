...
if(isset($_POST["Submit"])){
    ...
    elseif(empty($PhoneNumber)){
        ...
        $Query = "INSERT INTO support_staff(Staff_id,FirstName,MiddleName,LastName,ID_number,Gender,Phone_number,Designation)  VALUES ('$StaffID', '$FirstName', '$MiddleName', '$LastName','$ID', '$Gender', '$PhoneNumber', '$Designation')";
        $Execute = mysqli_query($con, $Query);

        if($Execute){
            $_SESSION["SuccessMessage"] = "Support Staff Added Successfully";
        Redirect_to("support.php");
        }else{
    ...
    <div class="container-fluid px-1 py-5 mx-auto">
        <div class="row d-flex justify-content-center">
            <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
                ...
                <div class="card">
                    <h5 class="text-center mb-5">Add A New Support Staff</h5>
                    <div><?php echo Message();
            echo SuccessMessage(); ?></div>
                    <form class="form-card" action="support.php" method="post">
                        ...
                        <div class="form-group col-sm-6"> <input class ="btn btn-success btn-lock" type="submit" name = "Submit" value ="Add New Support Staff"> </div>
</div>
                    </form>
                </div>
            </div>
