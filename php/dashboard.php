    ...
    <div class="row">
        <div class="col-sm-2">
            ...
            <ul id="Side_Menu"  class="nav nav-pills nav-stacked">
                ...
                <li><a href="../php/student.php"> <span class="glyphicon glyphicon-user"></span> &nbsp; Students</a></li>
                <li><a href="../php/teachers.php"> <span class="glyphicon glyphicon-list-alt"></span> &nbsp; Teachers</a></li>
                <li><a href="../php/support.php"> <span class="glyphicon glyphicon-tags"></span> &nbsp; Support Staff</a></li>
